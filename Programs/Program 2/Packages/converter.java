import java.util.*;
import convertor.ex2acurrency;
import convertor.ex2distance;
import convertor.ex2timer;
public
class converter {
    public static void main(String args[]) {
        Scanner s = new Scanner(System.in);
        int choice, ch;
        ex2acurrency c = new ex2acurrency();
        ex2distance d = new ex2distance();
        ex2timer t = new ex2timer();
        do {
